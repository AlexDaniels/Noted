					...
					<div className='col-md-1 col-xs-12'>
						<div style={this.state.toolStyle} className="input-group" role="group" aria-label="Basic example">
							<div className='col-xs-3 col-md-12'>
								<input id='slider' type="range" min='0' max='360'></input>
								<div>Angle</div>
							</div>
							...
							<div id='noteColor' className="col-xs-1 col-md-12 button-group colorPicker" role="group">
								...
								<div className="dropdown-menu" aria-labelledby="btnGroupDrop1">
									<button className="col-md-12 col-xs-2 dropdown-item btn"></button>
									<button className="col-md-12 col-xs-2 dropdown-item btn"></button>
									<button className="col-md-12 col-xs-2 dropdown-item btn"></button>
									<button className="col-md-12 col-xs-2 dropdown-item btn"></button>
									<button className="col-md-12 col-xs-2 dropdown-item btn"></button>
							...
							<button id='save' type="button" className="btn btn-secondary col-xs-1 col-xs-offset-1 col-md-offset-0 col-md-12"></button>
							<button id='change' type="button" className="btn btn-secondary col-xs-1 col-md-12"></button>
							<button id='delete' type="button" className="btn btn-secondary col-xs-1 col-md-12"></button>
							<button id='cancel' type="button" className="btn btn-secondary col-xs-1 col-md-12"></button>
							<button id='chat' type="button" className="btn btn-secondary col-xs-1 col-xs-offset-1 col-md-offset-0 col-md-12"></button>
						</div>
					</div>
